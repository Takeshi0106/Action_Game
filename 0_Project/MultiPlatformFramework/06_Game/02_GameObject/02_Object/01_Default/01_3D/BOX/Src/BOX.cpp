...
// 初期化
// ==================================
bool BOX::Init(IDrawManager* drawManager)
{
	// 頂点バッファ作成
...
// 描画
// ==================================
void BOX::Draw(IDrawManager* drawManager, const Color& color)
{
...
// AABB描画
void BOX::DrawAABB(IDrawManager* drawManager, const AABBCollider& aabb, const Color& color)
{
	// サイズ計算
