...
// ======================================
// 衝突判定関数テーブル初期化
CollisionModule::CollisionFunc
CollisionModule::collisionFuncTable[MAX_SHAPE_TYPE][MAX_SHAPE_TYPE] = {};
...
// 当たり判定チェック関数
// ======================================
bool CollisionModule::CheckCollision(
...
// AABB同士の当たり判定
// ======================================
bool CollisionModule::AABB_AABB_Check(void* _a, void* _b)
{
	// 型変換
