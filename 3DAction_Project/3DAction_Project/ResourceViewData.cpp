    ...
    UINT mipLevels)
{
    ...
    desc.Format = format;
    desc.ViewDimension = viewDim;

    if (viewDim == D3D11_SRV_DIMENSION_TEXTURE2D)
    {
    ...
    UINT mipSlice)
{
    ...
    if (viewDim == D3D11_UAV_DIMENSION_TEXTURE2D)
    {
    ...
    UINT mipSlice)
{
    ...
    if (viewDim == D3D11_RTV_DIMENSION_TEXTURE2D)
    {
        desc.Texture2D.MipSlice = mipSlice;
    }
    ...
    UINT mipSlice)
{
    ...
    if (viewDim == D3D11_DSV_DIMENSION_TEXTURE2D)
    {
        desc.Texture2D.MipSlice = mipSlice;
    }
